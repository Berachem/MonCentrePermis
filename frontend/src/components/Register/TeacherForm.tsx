...
const TeacherForm = forwardRef((_, ref) =>{
            ...
            <ScrollPanel className="w-full h-full formScrollbar">
                <div className="pr-3 pb-4">
                    <form onSubmit={(e)=>{e.preventDefault();handleSubmit();}} className="flex flex-col gap-4 w-full">
                        ...
                        <div className="flex flex-col w-full mb-2">
                            <label htmlFor="dateDebutCarriere" className="text-green-800 font-medium mb-1">Date de début de carrière</label>
                            <Calendar 
                                id="dateDebutCarriere" 
                                value={dateDebutCarriere} 
                                onChange={(e) => setDateDebutCarriere(e.value as Date)} 
                                dateFormat="dd/mm/yy" 
                                className="w-full"
                                inputClassName="w-full border border-gray-300 rounded-lg p-2 focus:border-green-800 focus:ring focus:ring-green-200 focus:ring-opacity-50"
                            />
