...
export default function Settings() {
    ...
    const mapBackgroundOptions = [
        { label: 'Light Mode', value: "https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png" },
        { label: 'Dark Mode', value: "https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png" },
       
        { label: 'Classique', value: "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" },
        { label: 'Real', value: "https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}" },
        { label: 'Grey Mode', value: "https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png" },
            ...
            <div className="flex flex-column lg:flex-row gap-4 justify-content-center mt-4">
                ...
                <div className=" w-full lg:w-3">
                    ...
                    <div className="field mb-4">
                        <label htmlFor="language" className="text-900 font-bold">Langue</label>
                        <Dropdown
                            id="language"
                            value={language}
                    ...
                    {/* Thème */}
                    <div className="field mb-4">
                        <label htmlFor="theme" className="text-900 font-bold">Thème</label>
                        <Dropdown
                            id="theme"
                            value={theme}
                    ...
                    <div className="field">
                        <label htmlFor="mapBackground" className="text-900 font-bold">Fond de Carte</label>
                        <Dropdown
                            id="mapBackground"
                            value={tileLayerUrl}
                ...
                <div className="w-full lg:w-7 flex align-items-center justify-content-center">
                    <Card title="Aperçu en Direct" className={`preview-card theme-${theme}`}>
                        <p className="font-semibold text-700">Voici un aperçu en direct des changements de fond de carte et de thème.</p>

                        {/* Exemple de fond de plan de carte */}
                        <div className="preview-map mt-4" style={{ width: '100%', height: '300px' }}>
                            <MapContainer center={[48.8566, 2.3522]} zoom={12} style={{ height: '100%', borderRadius: '8px' }} >
