    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="flex justify-center items-center flex-grow p-6">
        <Card
          ...
          className="w-full max-w-2xl shadow-lg rounded-lg bg-white p-4"
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="mb-4">
              <label htmlFor="libelle" className="font-bold block mb-2 text-green-700 mt-4">
                Nom du circuit *
              </label>
              <InputText
                id="libelle"
            ...
            <div className="mb-4">
              <label htmlFor="ville" className="font-bold block mb-2 text-green-700">
                Ville de référence *
              </label>
              <AutoComplete
                id="ville"
                value={selectedVille || undefined}
                ...
                required
                className="w-full"
                inputClassName="w-full border rounded-md p-1"
              />
            </div>
            ...
            <div className="flex justify-between mt-4">
              <Button
                label="Annuler"
                icon="pi pi-times"
                className="p-button-outlined bg-white text-gray-700 border border-gray-300 px-4 py-2 rounded-md hover:bg-gray-100 gap-2"
                onClick={() => navigate(-1)}
                type="button"
              />
              <Button
